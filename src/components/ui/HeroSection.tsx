...
return (
    <>
      ...
      <div
        className="h-[90vh] md:h-[100vh] w-full flex flex-col justify-center items-center relative overflow-hidden mx-auto py-10 md:py-0"
      >
        <Spotlight
...
Download your favorite HD songs instantly, completely free! No signups, no logins required – simply search for the song you love and hit download. Enjoy hassle-free music at your fingertips!        </p>
 ...
 >
   ...
   You can now save, share, and download HD songs for free using the power of Strike AI.
